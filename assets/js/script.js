...
const risultatoDadiGiocatore = document.getElementById("risultatoDadiGiocatore");
const risultatoDadiComputer = document.getElementById("risultatoDadiComputer");
...
giocaDadiBtn.addEventListener('click', function () {
    ...
    //Risultato del gioco dei dadi con il punteggio del giocatore
    risultatoDadiGiocatore.textContent = 'Il punteggio del giocatore è: ' + punteggioGiocatore + '\n';

    //Generare un numero causale da 1 a 6 per il pc
    const punteggioPc = Math.floor(Math.random() * 6) + 1;
    console.log(punteggioPc);

    //Risultato del gioco dei dadi con il punteggio del computer
    risultatoDadiComputer.textContent = 'Il punteggio del computer è: ' + punteggioPc + '\n';
